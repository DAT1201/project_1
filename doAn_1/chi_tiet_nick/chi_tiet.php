...
<body>
	...
	<div id="div_chi_tiet">
	 	...
	 	<?php foreach ($result as $each): ?>
	 		<table width="80%" border="1" style="margin: auto;">
			 	<tr>
			 		<td>
			 			<img style="height: 650px;width: 100%;background-position: center center;" src="<?php echo $thu_muc_anh . $each['anh'] ?>">	
			 		</td>
			 		<br>
	...
	<div style="background-color: rgb(138, 254, 0,0.5);width:30%;margin: auto;">
		<a href="../gio_hang/gio_hang.php?ma=<?php echo $ma_tai_khoan ?>&ma_danh_muc=<?php echo $ma_danh_muc ?>">thêm giỏ</a>
	</div>
